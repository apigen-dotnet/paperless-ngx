...
public partial class LogsClient
{
  ...
  /// </summary>
  public async Task<JsonElement> LogsListAsync(CancellationToken cancellationToken = default)
  {
    string url = "logs/";
  ...
  /// </summary>
  public async Task<JsonElement> RetrieveLogAsync(string id, RetrieveLogRequest? request = null, CancellationToken cancellationToken = default)
  {
