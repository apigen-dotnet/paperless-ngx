...
public partial class TasksClient
{
  ...
  /// </summary>
  public async Task<List<TasksView>> TasksListAsync(TasksListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<TasksView> TasksRetrieveAsync(int id, TasksRetrieveRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<AcknowledgeTasks> AcknowledgeTasksAsync(Apigen.PaperlessNgx.Models.AcknowledgeTasksRequest acknowledgeTasksRequest, AcknowledgeTasksRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<TasksView> TasksRunCreateAsync(Apigen.PaperlessNgx.Models.TasksViewRequest tasksViewRequest, TasksRunCreateRequest? request = null, CancellationToken cancellationToken = default)
  {
