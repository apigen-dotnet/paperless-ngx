...
public partial class MailRulesClient : IMailRulesClient
{
  ...
  /// </summary>
  public async Task<PaginatedMailRuleList> ListAsync(MailRulesListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailRule> CreateAsync(Apigen.PaperlessNgx.Models.MailRuleRequest mailRuleRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailRule> GetAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailRule> UpdateAsync(int id, Apigen.PaperlessNgx.Models.MailRuleRequest mailRuleRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<MailRule> PartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedMailRuleRequest patchedMailRuleRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
