...
public partial class RemoteVersionClient
{
  ...
  internal RemoteVersionClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<JsonElement> RemoteVersionRetrieveAsync(CancellationToken cancellationToken = default)
  {
    string url = "remote_version/";
