...
public partial class SavedViewsClient
{
  ...
  /// </summary>
  public async Task<PaginatedSavedViewList> SavedViewsListAsync(SavedViewsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<SavedView> SavedViewsCreateAsync(Apigen.PaperlessNgx.Models.SavedViewRequest savedViewRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<SavedView> SavedViewsRetrieveAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<SavedView> SavedViewsUpdateAsync(int id, Apigen.PaperlessNgx.Models.SavedViewRequest savedViewRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<SavedView> SavedViewsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedSavedViewRequest patchedSavedViewRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task SavedViewsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
