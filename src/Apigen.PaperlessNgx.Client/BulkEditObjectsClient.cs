...
public partial class BulkEditObjectsClient
{
  ...
  /// </summary>
  public async Task<BulkEditResult> BulkAsync(Apigen.PaperlessNgx.Models.BulkEditObjectsRequest bulkEditObjectsRequest, CancellationToken cancellationToken = default)
  {
