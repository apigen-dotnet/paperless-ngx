...
public partial class StoragePathsClient
{
  ...
  /// </summary>
  public async Task<PaginatedStoragePathList> StoragePathsListAsync(StoragePathsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<StoragePath> StoragePathsCreateAsync(Apigen.PaperlessNgx.Models.StoragePathRequest storagePathRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<StoragePath> StoragePathsRetrieveAsync(int id, StoragePathsRetrieveRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<StoragePath> StoragePathsUpdateAsync(int id, Apigen.PaperlessNgx.Models.StoragePathRequest storagePathRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<StoragePath> StoragePathsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedStoragePathRequest patchedStoragePathRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task StoragePathsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<StoragePath> StoragePathsTestCreateAsync(Apigen.PaperlessNgx.Models.StoragePathRequest storagePathRequest, CancellationToken cancellationToken = default)
  {
