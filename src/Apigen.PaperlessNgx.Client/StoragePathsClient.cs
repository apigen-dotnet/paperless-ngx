...
/// </summary>
public partial class StoragePathsClient : IStoragePathsClient
{
  ...
  /// </summary>
  public async Task<PaginatedStoragePathList> ListAsync(StoragePathsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<StoragePath> CreateAsync(Apigen.PaperlessNgx.Models.StoragePathRequest storagePathRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<StoragePath> GetAsync(int id, StoragePathsRetrieveRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<StoragePath> UpdateAsync(int id, Apigen.PaperlessNgx.Models.StoragePathRequest storagePathRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<StoragePath> PartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedStoragePathRequest patchedStoragePathRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<string> TestAsync(Apigen.PaperlessNgx.Models.StoragePathTestRequest storagePathTestRequest, CancellationToken cancellationToken = default)
  {
    ...
    try
    {
      long startTimestamp = System.Diagnostics.Stopwatch.GetTimestamp();
      HttpClientLog.LogDebugRequestStarted(_logger, "POST", url);
      string json = JsonSerializer.Serialize(storagePathTestRequest, JsonConfig.Default);
      HttpClientLog.LogTraceRequestBody(_logger, "POST", "application/json", json);
      StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
      HttpResponseMessage response = await _httpClient.PostAsync(url, content, cancellationToken);
      long durationMs = (long)System.Diagnostics.Stopwatch.GetElapsedTime(startTimestamp).TotalMilliseconds;
