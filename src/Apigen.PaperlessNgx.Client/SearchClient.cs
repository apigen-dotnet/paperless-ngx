...
public partial class SearchClient
{
  ...
  /// </summary>
  public async Task<SearchResult> SearchRetrieveAsync(SearchRetrieveRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<JsonElement> SearchAutocompleteListAsync(SearchAutocompleteListRequest? request = null, CancellationToken cancellationToken = default)
  {
