...
public partial class WorkflowsClient
{
  ...
  /// </summary>
  public async Task<PaginatedWorkflowList> WorkflowsListAsync(WorkflowsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Workflow> WorkflowsCreateAsync(Apigen.PaperlessNgx.Models.WorkflowRequest workflowRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Workflow> WorkflowsRetrieveAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Workflow> WorkflowsUpdateAsync(int id, Apigen.PaperlessNgx.Models.WorkflowRequest workflowRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Workflow> WorkflowsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedWorkflowRequest patchedWorkflowRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task WorkflowsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
