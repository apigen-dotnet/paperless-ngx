...
/// </summary>
public partial class MailAccountsClient : IMailAccountsClient
{
  ...
  /// </summary>
  public async Task<PaginatedMailAccountList> ListAsync(MailAccountsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailAccount> CreateAsync(Apigen.PaperlessNgx.Models.MailAccountRequest mailAccountRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailAccount> GetAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailAccount> UpdateAsync(int id, Apigen.PaperlessNgx.Models.MailAccountRequest mailAccountRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<MailAccount> PartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedMailAccountRequest patchedMailAccountRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<MailAccountProcessResponse> ProcessAsync(int id, Apigen.PaperlessNgx.Models.MailAccountRequest mailAccountRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<MailAccountTestResponse> TestAsync(Apigen.PaperlessNgx.Models.MailAccountRequest mailAccountRequest, CancellationToken cancellationToken = default)
  {
