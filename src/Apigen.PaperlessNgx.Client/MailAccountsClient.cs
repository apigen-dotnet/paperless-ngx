...
public partial class MailAccountsClient
{
  ...
  /// </summary>
  public async Task<PaginatedMailAccountList> MailAccountsListAsync(MailAccountsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailAccount> MailAccountsCreateAsync(Apigen.PaperlessNgx.Models.MailAccountRequest mailAccountRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailAccount> MailAccountsRetrieveAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<MailAccount> MailAccountsUpdateAsync(int id, Apigen.PaperlessNgx.Models.MailAccountRequest mailAccountRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<MailAccount> MailAccountsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedMailAccountRequest patchedMailAccountRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task MailAccountsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<MailAccountProcessResponse> MailAccountProcessAsync(int id, Apigen.PaperlessNgx.Models.MailAccountRequest mailAccountRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<MailAccountTestResponse> MailAccountTestAsync(Apigen.PaperlessNgx.Models.MailAccountRequest mailAccountRequest, CancellationToken cancellationToken = default)
  {
