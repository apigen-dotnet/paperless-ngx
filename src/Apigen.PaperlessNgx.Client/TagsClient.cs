...
public class TagsClient
{
  ...
  /// </summary>
  public async Task<PaginatedTagList> TagsListAsync(TagsListRequest? request = null)
  {
  ...
  /// </summary>
  public async Task<Tag> TagsCreateAsync(Apigen.PaperlessNgx.Models.TagRequest tagRequest)
  {
    string url = "tags/";
  ...
  /// </summary>
  public async Task<Tag> TagsRetrieveAsync(int id, TagsRetrieveRequest? request = null)
  {
  ...
  /// </summary>
  public async Task<Tag> TagsUpdateAsync(int id, Apigen.PaperlessNgx.Models.TagRequest tagRequest)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Tag> TagsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedTagRequest patchedTagRequest)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task TagsDestroyAsync(int id)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
