...
public partial class TagsClient
{
  ...
  /// </summary>
  public async Task<PaginatedTagList> TagsListAsync(TagsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Tag> TagsCreateAsync(Apigen.PaperlessNgx.Models.TagRequest tagRequest, CancellationToken cancellationToken = default)
  {
    string url = "tags/";
  ...
  /// </summary>
  public async Task<Tag> TagsRetrieveAsync(int id, TagsRetrieveRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Tag> TagsUpdateAsync(int id, Apigen.PaperlessNgx.Models.TagRequest tagRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Tag> TagsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedTagRequest patchedTagRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task TagsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
