...
public partial class UsersClient
{
  ...
  /// </summary>
  public async Task<PaginatedUserList> UsersListAsync(UsersListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<User> UsersCreateAsync(Apigen.PaperlessNgx.Models.UserRequest userRequest, CancellationToken cancellationToken = default)
  {
    string url = "users/";
  ...
  /// </summary>
  public async Task<User> UsersRetrieveAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<User> UsersUpdateAsync(int id, Apigen.PaperlessNgx.Models.UserRequest userRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<User> UsersPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedUserRequest patchedUserRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task UsersDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<JsonElement> UsersDeactivateTotpCreateAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
