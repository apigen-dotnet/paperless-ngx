...
public partial class UiSettingsClient
{
  ...
  /// </summary>
  public async Task<UiSettingsView> UiSettingsRetrieveAsync(CancellationToken cancellationToken = default)
  {
    ...
    try
    {
      ...
      UiSettingsView? result = JsonSerializer.Deserialize<UiSettingsView>(responseContent, JsonConfig.Default);
      return result ?? new UiSettingsView();
    }
  ...
  /// </summary>
  public async Task<UiSettingsView> UiSettingsCreateAsync(Apigen.PaperlessNgx.Models.UiSettingsViewRequest uiSettingsViewRequest, CancellationToken cancellationToken = default)
  {
    string url = "ui_settings/";
    ...
    try
    {
      ...
      string json = JsonSerializer.Serialize(uiSettingsViewRequest, JsonConfig.Default);
