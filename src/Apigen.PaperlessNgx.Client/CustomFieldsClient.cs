...
public partial class CustomFieldsClient
{
  ...
  /// </summary>
  public async Task<PaginatedCustomFieldList> CustomFieldsListAsync(CustomFieldsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<CustomField> CustomFieldsCreateAsync(Apigen.PaperlessNgx.Models.CustomFieldRequest customFieldRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<CustomField> CustomFieldsRetrieveAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<CustomField> CustomFieldsUpdateAsync(int id, Apigen.PaperlessNgx.Models.CustomFieldRequest customFieldRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<CustomField> CustomFieldsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedCustomFieldRequest patchedCustomFieldRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task CustomFieldsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
