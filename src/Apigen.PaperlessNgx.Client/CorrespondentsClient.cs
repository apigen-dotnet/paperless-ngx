...
public partial class CorrespondentsClient
{
  ...
  /// </summary>
  public async Task<PaginatedCorrespondentList> CorrespondentsListAsync(CorrespondentsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Correspondent> CorrespondentsCreateAsync(Apigen.PaperlessNgx.Models.CorrespondentRequest correspondentRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Correspondent> CorrespondentsRetrieveAsync(int id, CorrespondentsRetrieveRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Correspondent> CorrespondentsUpdateAsync(int id, Apigen.PaperlessNgx.Models.CorrespondentRequest correspondentRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Correspondent> CorrespondentsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedCorrespondentRequest patchedCorrespondentRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task CorrespondentsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
