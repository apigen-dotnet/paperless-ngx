...
public partial class WorkflowActionsClient
{
  ...
  /// </summary>
  public async Task<PaginatedWorkflowActionList> WorkflowActionsListAsync(WorkflowActionsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowAction> WorkflowActionsCreateAsync(Apigen.PaperlessNgx.Models.WorkflowActionRequest workflowActionRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowAction> WorkflowActionsRetrieveAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowAction> WorkflowActionsUpdateAsync(int id, Apigen.PaperlessNgx.Models.WorkflowActionRequest workflowActionRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<WorkflowAction> WorkflowActionsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.WorkflowActionRequest workflowActionRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task WorkflowActionsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
