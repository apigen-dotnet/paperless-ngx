...
/// </summary>
public partial class WorkflowActionsClient : IWorkflowActionsClient
{
  ...
  /// </summary>
  public async Task<PaginatedWorkflowActionList> ListAsync(WorkflowActionsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowAction> CreateAsync(Apigen.PaperlessNgx.Models.WorkflowActionRequest workflowActionRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowAction> GetAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowAction> UpdateAsync(int id, Apigen.PaperlessNgx.Models.WorkflowActionRequest workflowActionRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<WorkflowAction> PartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.WorkflowActionRequest workflowActionRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
