...
public partial class DocumentTypesClient
{
  ...
  /// </summary>
  public async Task<PaginatedDocumentTypeList> DocumentTypesListAsync(DocumentTypesListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<DocumentType> DocumentTypesCreateAsync(Apigen.PaperlessNgx.Models.DocumentTypeRequest documentTypeRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<DocumentType> DocumentTypesRetrieveAsync(int id, DocumentTypesRetrieveRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<DocumentType> DocumentTypesUpdateAsync(int id, Apigen.PaperlessNgx.Models.DocumentTypeRequest documentTypeRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<DocumentType> DocumentTypesPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedDocumentTypeRequest patchedDocumentTypeRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task DocumentTypesDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
