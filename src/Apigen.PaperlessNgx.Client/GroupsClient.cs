...
public partial class GroupsClient
{
  ...
  /// </summary>
  public async Task<PaginatedGroupList> GroupsListAsync(GroupsListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Group> GroupsCreateAsync(Apigen.PaperlessNgx.Models.GroupRequest groupRequest, CancellationToken cancellationToken = default)
  {
    string url = "groups/";
  ...
  /// </summary>
  public async Task<Group> GroupsRetrieveAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<Group> GroupsUpdateAsync(int id, Apigen.PaperlessNgx.Models.GroupRequest groupRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<Group> GroupsPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedGroupRequest patchedGroupRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task GroupsDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
