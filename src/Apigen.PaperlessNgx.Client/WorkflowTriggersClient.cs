...
/// </summary>
public partial class WorkflowTriggersClient
{
  ...
  /// </summary>
  public async Task<PaginatedWorkflowTriggerList> WorkflowTriggersListAsync(WorkflowTriggersListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowTrigger> WorkflowTriggersCreateAsync(Apigen.PaperlessNgx.Models.WorkflowTriggerRequest workflowTriggerRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowTrigger> WorkflowTriggersRetrieveAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowTrigger> WorkflowTriggersUpdateAsync(int id, Apigen.PaperlessNgx.Models.WorkflowTriggerRequest workflowTriggerRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<WorkflowTrigger> WorkflowTriggersPartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedWorkflowTriggerRequest patchedWorkflowTriggerRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task WorkflowTriggersDestroyAsync(int id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
