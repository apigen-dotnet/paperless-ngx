...
/// </summary>
public partial class WorkflowTriggersClient : IWorkflowTriggersClient
{
  ...
  /// </summary>
  public async Task<PaginatedWorkflowTriggerList> ListAsync(WorkflowTriggersListRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowTrigger> CreateAsync(Apigen.PaperlessNgx.Models.WorkflowTriggerRequest workflowTriggerRequest, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowTrigger> GetAsync(int id, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<WorkflowTrigger> UpdateAsync(int id, Apigen.PaperlessNgx.Models.WorkflowTriggerRequest workflowTriggerRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
  ...
  /// </summary>
  public async Task<WorkflowTrigger> PartialUpdateAsync(int id, Apigen.PaperlessNgx.Models.PatchedWorkflowTriggerRequest patchedWorkflowTriggerRequest, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id
