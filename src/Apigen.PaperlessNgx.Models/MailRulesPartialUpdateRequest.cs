...
/// <summary>
/// MailRulesPartialUpdateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/MailRulesPartialUpdateRequest
/// </summary>
public class MailRulesPartialUpdateRequest
{
  [MinLength(1)]
  [MaxLength(256)]
