...
/// <summary>
/// DocumentsBulkDownloadCreateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/DocumentsBulkDownloadCreateRequest
/// </summary>
public class DocumentsBulkDownloadCreateRequest
{
  [Required]
