...
/// <summary>
/// StoragePathsTestCreateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/StoragePathsTestCreateRequest
/// </summary>
public class StoragePathsTestCreateRequest
{
  [Required]
  [MinLength(1)]
  [MaxLength(128)]
