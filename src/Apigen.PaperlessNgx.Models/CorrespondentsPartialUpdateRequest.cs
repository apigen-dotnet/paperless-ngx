...
/// <summary>
/// CorrespondentsPartialUpdateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/CorrespondentsPartialUpdateRequest
/// </summary>
public class CorrespondentsPartialUpdateRequest
{
  [MinLength(1)]
  [MaxLength(128)]
