...
/// <summary>
/// DocumentTypesPartialUpdateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/DocumentTypesPartialUpdateRequest
/// </summary>
public class DocumentTypesPartialUpdateRequest
{
  [MinLength(1)]
  [MaxLength(128)]
