...
/// <summary>
/// SavedViewsPartialUpdateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/SavedViewsPartialUpdateRequest
/// </summary>
public class SavedViewsPartialUpdateRequest
{
  [MinLength(1)]
  [MaxLength(128)]
