...
/// <summary>
/// WorkflowTriggersUpdateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/WorkflowTriggersUpdateRequest
/// </summary>
public class WorkflowTriggersUpdateRequest
{
