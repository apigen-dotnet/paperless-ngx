...
/// <summary>
/// StoragePathsPartialUpdateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/StoragePathsPartialUpdateRequest
/// </summary>
public class StoragePathsPartialUpdateRequest
{
  [MinLength(1)]
  [MaxLength(128)]
