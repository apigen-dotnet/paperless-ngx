...
/// <summary>
/// WorkflowTriggersCreateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/WorkflowTriggersCreateRequest
/// </summary>
public class WorkflowTriggersCreateRequest
{
