...
/// <summary>
/// ShareLinksPartialUpdateRequest from OpenAPI schema.
/// Schema path: #/components/schemas/ShareLinksPartialUpdateRequest
/// </summary>
public class ShareLinksPartialUpdateRequest
{
